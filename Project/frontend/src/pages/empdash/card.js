		...
		<div className='cusdashcard'>
                <a href="#" className="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-600 dark:hover:bg-gray-700 cuscardx">
                    ...
                    <div className="flex flex-col justify-between p-4 leading-normal">
                        <h5 className="mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-gray-300">{localStorage.getItem("empFname")} {localStorage.getItem("empLname")}</h5>
                        <p className="mb-3 font-normal text-gray-700 dark:text-gray-300">{localStorage.getItem("empPosition")}</p>
                ...
                <a href="#" className="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-600 dark:hover:bg-gray-700 cuscardx">
                    <div className="color">
                        ...
                        <div class="cardbutton mt-0.5">
                            <a href =  {`/empdash/empupdate/${localStorage.getItem("empID")}`}><button type="button" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-10 py-2.5 text-center mr-2 mb-2">Update Profile</button></a>
                            <a href = "/empdash/empdanger"><button type="button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-10 py-2.5 text-center mr-2 mb-2">Danger Zone</button></a>
                        </div>
                    </div>
                </a>
            </div>
