                ...
                <div
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#">
                            <div>
                                <div>
                                    ...
                                    <label for="loan_purpose"
                                        ...
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Employee Name</label>
                            ...
                            <div>
                                <label for="empno"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Number of Actions</label>
