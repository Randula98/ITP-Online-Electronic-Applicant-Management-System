...
export default function OfferSection() {
	...
	useEffect(() => {
		async function getRecords() {
			const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/item/random`);
		...
		<div>
			...
			<div className="header-bar">
				<div className="header">
					<h1 className="font-medium leading-tight text-5xl mt-0 mb-2 text-black-600">Special Offer Discounts!!!</h1>
				</div>
			</div>
