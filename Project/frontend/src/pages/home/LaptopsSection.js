...
export default function LaptopSection() {
	...
	useEffect(() => {
		async function getRecords() {
			const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/item/random/Laptops`);
		...
		<div>
			...
			<div className="header-bar">
				<div className="header">
					<h1 className="font-medium leading-tight text-5xl mt-0 mb-2 text-black-600">Laptops on Sale!!!</h1>
				</div>
			</div>
