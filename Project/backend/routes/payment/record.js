...
paymentRoutes.route("/payment").get(function (req, res) {
...
paymentRoutes.route("/payment/add").post(function (req, response) {
	let db_connect = dbo.getDb("synthetic");
	let myobj = {
...
paymentRoutes.route("/payment/update/:id").post(function (req, response) {
	let db_connect = dbo.getDb("synthetic");
	let myquery = { _id: ObjectId(req.params.id) };
	let newvalues = {
		$set: {
...
paymentRoutes.route("/payment/delete/:id").delete((req, response) => {
	let db_connect = dbo.getDb("synthetic");
	let myquery = { _id: ObjectId(req.params.id) };
